package com.java.jdbcTemplate.utils;
...
public class ReflectUtil {
	...
	public static <T> T newInstance(Class<T> clazz) throws Exception {
		if (clazz.isInterface()) {
			throw new Exception("Specified class is an interface"+clazz);
		}
		try {
			...
			throw new Exception("Is the constructor accessible?"+clazz, ex);
		}
	}
